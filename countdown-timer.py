...
window.title("Lavatech Technology-Countdown timer and notification")
...
title_label_1 = Label(window, text="Lavatech Countdown timer with notification",font=("Gayathri", 11)).pack()
